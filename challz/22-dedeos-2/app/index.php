...
<p><b>Note :</b> un malicieux pirate a compromis le système de l'ancien serveur, mais j'ai résolu cette faille ! Qui est le plus malin de nous deux maintenant ?</p>
	<form method="post">
